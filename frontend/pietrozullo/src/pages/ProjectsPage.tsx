        ...
        <Card className="overflow-hidden">
          <div className="md:grid md:grid-cols-2">
            <CardContent className="p-6 space-y-4 order-2 md:order-1">
              <h3 className="text-2xl font-bold">Model Predictive Control for High Performance Driving</h3>
              <p>
                On behalf of IDSC Zurich I collaborated with UniPD and UniNA to conduct an analysis on a commercial software 
                to control vehicles in high performance driving, successfully improving its accuracy and overall performance.
              </p>
              <p>
                I refined the work done by previous developers which used the MATLAB tool MATMPC to develop a NMPCC controller 
                for high performance driving. This was used to control highly accurate virtual vehicles in a cosimulation environment.
              </p>
              <div className="flex flex-wrap gap-3 pt-4">
            ...
            <div className="bg-muted p-6 flex items-center justify-center order-1 md:order-2">
              <div className="text-center p-6">
      ...
      <section className="space-y-8">
        ...
        <Card className="overflow-hidden">
          <div className="md:grid md:grid-cols-2">
            <div className="bg-muted p-6 flex items-center justify-center">
              <div className="text-center p-6">
                <Badge className="mb-4">2024</Badge>
                <h3 className="text-2xl font-bold mb-2">Virtual Try-on Technology</h3>
                <p className="text-muted-foreground">
                  Patent Pending (CH001377/2024)
                </p>
              </div>
            </div>
            <CardContent className="p-6 space-y-4">
              <h3 className="text-2xl font-bold">Virtual Try-on Technology</h3>
              <p>
                Patent pending for innovative virtual try-on technology that allows users to visualize products 
                in a realistic way before purchasing.
              </p>
              <div className="flex flex-wrap gap-3 pt-4">
              ...
              <div className="pt-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">January 2024 - Pending</p>
              </div>
            </CardContent>
          </div>
        </Card>
